...
前方から次々に降ってくるAndroidロボット@<fn>{source_androidrobot}を避けるゲームです。
...
//footnote[source_androidrobot][@<href>{https://developer.android.com/distribute/marketing-tools/brand-guidelines#android_robot}]
